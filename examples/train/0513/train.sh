...
USE_MODELSCOPE_HUB=1 CUDA_VISIBLE_DEVICES=0 python src/train.py examples/train/0513/exp2.yaml > log/exp2.log 2>&1
echo "Start training exp3"
USE_MODELSCOPE_HUB=1 CUDA_VISIBLE_DEVICES=0 python src/train.py examples/train/0513/exp3.yaml > log/exp3.log 2>&1
echo "Start training exp4"
USE_MODELSCOPE_HUB=1 CUDA_VISIBLE_DEVICES=0 python src/train.py examples/train/0513/exp4.yaml > log/exp4.log 2>&1
